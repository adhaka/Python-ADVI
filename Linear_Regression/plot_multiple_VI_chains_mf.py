...
plt.legend()
plt.savefig('plots/vi_chains_sigma_MF.pdf')
...
plt.legend()
plt.savefig('plots/R_hat_vs_iters_MF.pdf')
...
plt.legend()
plt.savefig('plots/K_hat_vs_iters_MF.pdf')
plt.figure()
...
plt.yscale('log')
plt.legend()
plt.savefig('Lin_Reg_MF_10D_500N_hmc_Gelbo.pdf')
...
plt.yscale('log')
plt.legend()
plt.savefig('Lin_Reg_MF_mean_10D_500N_hmc_Gelbo.pdf')
#plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Lin_Reg_MF_sigmas_10D_500N_hmc_Gelbo.pdf')
